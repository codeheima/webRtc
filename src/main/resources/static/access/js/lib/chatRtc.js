var chatRtc = function() {
   ...
   // var getUserMedia = (navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia || navigator.msGetUserMedia);
    ...
    skyrtc.prototype.countTime = function(){
    	setInterval(function(){
    		var now = new Date();
    		var dur = parseInt(now.getTime()/1000)-parseInt(startTime.getTime()/1000);
	        var beginT = new Array();
	        var dh = parseInt(dur/3600);
	        var dm = parseInt((dur-dh*3600)/60);
	        var ds = dur - dh*3600 - dm*60;
